        ...
        .then((res) => {
          ...
          for (var answer of StatsResult) {
            ...
            regionArray.push([
              ...
              Number(answer.respondentRegion_gyeonggi),
              Number(answer.respondentRegion_gwangju),
              Number(answer.respondentRegion_daegu),
              Number(answer.respondentRegion_daejeon),
              Number(answer.respondentRegion_busan),
              Number(answer.respondentRegion_incheon),
              Number(answer.respondentRegion_ulsan),
              Number(answer.respondentRegion_sejong),
              Number(answer.respondentRegion_jeju),
              Number(answer.respondentRegion_gangwon),
              Number(answer.respondentRegion_gyeongsang),
              Number(answer.respondentRegion_jeolla),
              Number(answer.respondentRegion_chungcheong),
            ]);
          }
